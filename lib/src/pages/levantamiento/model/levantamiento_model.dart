...
LevantamientoModel levantamientoModelFromJson(String str) => LevantamientoModel.fromJson(json.decode(str));

String levantamientoModelToJson(LevantamientoModel data) => json.encode(data.toJson());
...
class LevantamientoModel {
    ...
    factory LevantamientoModel.fromJson(Map<String, dynamic> json) => LevantamientoModel(
        folio: json["folio"],
